...
在安装SGF6112设备之前、请确认您的StorageGRID 系统正在使用所需版本的StorageGRID 软件。
...
StorageGRID 管理网络是一个可选网络，用于系统管理和维护。设备使用设备上的以下端口连接到管理网络。

下图显示了SG6112设备上的RJ-45端口。

image::../media/sg6100_rj_45_ports_circled.png[SG6112 RJ-45端口]
...
下图显示了SG6112设备上的BMC管理端口。

image::../media/sgf6112_cn_bmc_management_port.png[SG6100管理端口]
...
|===
.相关信息
* link:cabling-appliance-sgf6112.html["电缆设备(SGF6112)"]
