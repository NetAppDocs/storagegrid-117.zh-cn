...
. link:../admin/web-browser-requirements.html["查看Web浏览器要求"]
. link:reviewing-appliance-network-connections.html["查看设备网络连接"]
. link:gathering-installation-information-overview.html["收集安装信息"]
...
. 电缆设备
+
** link:cabling-appliance-sgf6112.html["GF6112"]
** link:cabling-appliance-sg6000.html["SG6000"]
** link:cabling-appliance-sg5700.html["SG5700"]
** link:cabling-appliance-sg100-and-sg1000.html["SG100和SG1000"]


. 连接电源线并接通电源
+
** link:connecting-power-cords-and-applying-power-sgf6112.html["GF6112"]
...
** link:connecting-power-cords-and-applying-power-sg100-and-sg1000.html["SG100和SG1000"]
...
. link:configuring-bmc-interface.html["配置BMC接口"] (SGF6112、SG6000、SG100和SG1000)
. 执行可选的设置步骤
+
** link:optional-enabling-node-encryption.html["启用节点加密"]
